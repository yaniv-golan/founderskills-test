...
def _run(artifacts: dict[str, dict | str], extra_args: list[str] | None = None):
...
def _make_checklist(items=None, run_id=None):
...
def _make_runway(net_cash=1000000, run_id=None):
...
class TestFullPass:
    ...
    def test_gate1_passes_without_commentary(self):
...
class TestMissingArtifacts:
    ...
    def test_missing_commentary_fails_at_gate2_for_spreadsheet(self):
    ...
    def test_missing_commentary_ok_for_deck(self):
...
class TestSkippedStubs:
    def test_skipped_ue_passes(self):
    ...
    def test_skipped_runway_passes(self):
    ...
    def test_skipped_commentary_passes_for_deck(self):
    ...
    def test_skipped_ue_and_runway_qualitative(self):
...
class TestContentQuality:
    def test_checklist_fail_missing_evidence(self):
    ...
    def test_checklist_warn_missing_evidence(self):
    ...
    def test_checklist_pass_missing_evidence(self):
    ...
    def test_checklist_wrong_count_fails(self):
    ...
    def test_null_critical_inputs_fails(self):
    ...
    def test_null_stage_fails(self):
    ...
    def test_null_cash_balance_warns(self):
    ...
    def test_commentary_missing_headline_fails(self):
    ...
    def test_commentary_missing_lenses_fails(self):
    ...
    def test_runway_null_baseline_warns(self):
    ...
    def test_runway_partial_analysis_passes(self):
    ...
    def test_empty_report_markdown_fails(self):
    ...
    def test_ue_insufficient_metrics_fails(self):
...
class TestCrossChecks:
    def test_stale_run_id_fails(self):
    ...
    def test_runway_cash_mismatch_warns(self):
    ...
    def test_timeseries_mrr_mismatch_warns(self):
    ...
    def test_arr_mrr_mismatch_warns(self):
...
class TestEdgeCases:
    ...
    def test_gate1_flag(self):
        """--gate 1 skips commentary check."""
        arts = _gate1_artifacts()
        rc, out, stderr = _run(arts, ["--gate", "1"])
        assert rc == 0

    def test_default_is_gate2(self):
